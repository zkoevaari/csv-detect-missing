...
invalid line is encountered (empty or less fields than expected).",
        ...
        .arg(
            clap::Arg::new("diff")
                ...
                .long("diff")
                .help(
                    "Diff mode (default): one delimiter-separated line per
gap",
                )
                .long_help(
